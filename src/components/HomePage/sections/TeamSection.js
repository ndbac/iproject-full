...
import Team02 from "../../../assets/images/team/team-02.png";
import Team03 from "../../../assets/images/team/team-03.png";
import Team04 from "../../../assets/images/team/team-04.png";
import Team05 from "../../../assets/images/team/team-05.png";
import Team06 from "../../../assets/images/team/team-06.png";
          ...
          <div class="w-full px-4">
            <div class="text-center mx-auto mb-[60px] max-w-[620px]">
              ...
              <p
                ...
                "
              >
                These people work on making KickIO better.
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="w-full sm:w-1/2 lg:w-1/4 px-4">
            <div class="mb-10 wow fadeInUp" data-wow-delay=".1s">
              <div
                ...
                "
              >
                <img src={Team01} alt="image" class="w-full rounded-full" />
          ...
          <div class="w-full sm:w-1/2 lg:w-1/4 px-4">
            <div class="mb-10 wow fadeInUp" data-wow-delay=".2s">
              <div
                ...
                "
              >
                <img src={Team03} alt="image" class="w-full rounded-full" />
                <span class="absolute top-0 left-0 z-[-1]">
                  <svg
                    width="71"
                    height="82"
              ...
              <div class="text-center">
                <h4 class="font-medium text-lg text-dark mb-2">Ta Ngoc Minh</h4>
                <p class="font-medium text-sm text-body-color mb-5">
                  CEO - founder
                </p>
                <div class="flex items-center justify-center">
          ...
          <div class="w-full sm:w-1/2 lg:w-1/4 px-4">
            <div class="mb-10 wow fadeInUp" data-wow-delay=".15s">
              <div
                ...
                "
              >
                <img src={Team02} alt="image" class="w-full rounded-full" />
                <span class="absolute top-0 left-0 z-[-1]">
                  <svg
                    width="71"
                    height="82"
          ...
          <div class="w-full sm:w-1/2 lg:w-1/4 px-4">
            <div class="mb-10 wow fadeInUp" data-wow-delay=".25s">
              <div
                ...
                "
              >
                <img src={Team04} alt="image" class="w-full rounded-full" />
                <span class="absolute top-0 left-0 z-[-1]">
                  <svg
                    width="71"
                    height="82"
          ...
          <div class="w-full sm:w-1/2 lg:w-1/4 px-4">
            <div class="mb-10 wow fadeInUp" data-wow-delay=".25s">
              <div
                ...
                "
              >
                <img src={Team05} alt="image" class="w-full rounded-full" />
                <span class="absolute top-0 left-0 z-[-1]">
                  <svg
                    width="71"
                    height="82"
          ...
          <div class="w-full sm:w-1/2 lg:w-1/4 px-4">
            <div class="mb-10 wow fadeInUp" data-wow-delay=".25s">
              <div
                ...
                "
              >
                <img src={Team06} alt="image" class="w-full rounded-full" />
                <span class="absolute top-0 left-0 z-[-1]">
                  <svg
                    width="71"
                    height="82"
              ...
              <div class="text-center">
                <h4 class="font-medium text-lg text-dark mb-2">Le Hoai Son</h4>
                <p class="font-medium text-sm text-body-color mb-5">
                  CHRO - Co-founder
                </p>
                <div class="flex items-center justify-center">
