...
const formSchema = Yup.object({
  from: Yup.string().required("Sender email is required"),
...
function ContactSection() {
  ...
  const sendingStatus = useSelector((state) => state?.sendMailReducer);
  const { appErr, isMailSent, loading, serverErr } = sendingStatus;
