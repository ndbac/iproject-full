...
import Graygrids from "../../assets/images/footer/brands/graygrids.svg";
import Lineicons from "../../assets/images/footer/brands/lineicons.svg";
import Uideck from "../../assets/images/footer/brands/uideck.svg";
import Shape01 from "../../assets/images/footer/shape-1.svg";
import Shape03 from "../../assets/images/footer/shape-3.svg";
              ...
              <ul class="flex flex-wrap items-center">
                <li>
                  <a
                    ...
                    "
                  >
                    <img src={Tailgrids} alt="tailgrids" />
                  </a>
                </li>
                <li>
                  <a
                ...
                <li>
                  <a
                    ...
                    "
                  >
                    <img src={EcommerceHTML} alt="ecommerce-html" />
                  </a>
                </li>
                <li>
                  <a
                ...
                <li>
                  <a
                    ...
                    "
                  >
                    <img src={Lineicons} alt="lineicons" />
                  </a>
                </li>
                <li>
                  <a
